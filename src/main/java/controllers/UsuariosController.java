...
//	     System.out.println("LOS RESULTADOS SON: " + results);
	...
	@RequestMapping(value = "/crearModulo/", method = RequestMethod.POST, consumes = {"application/xml", "application/json"})
...
Configuration cf = new Configuration().configure("hibernate.cfg.xml");
	...
	@RequestMapping(value = "/actualizarModulo/", method = RequestMethod.POST, consumes = {"application/xml", "application/json"})
